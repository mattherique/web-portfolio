...
const AboutPage: React.FC = () => {
    ...
    return (
        <div className='w-full flex justify-center'>
            <div className='flex flex-col gap-y-20 mx-12 xl:mx-auto w-full max-w-6xl font-[family-name:var(--font-wotfard)] justify-center text-black my-20'>
                <div className='w-full'>
                    ...
                    <div className='flex flex-col gap-y-5'>
                        ...
                        <p className='text-2xl text-gray-500'>
                            Passionate about coding and always eager to learn new skills, i have been coding for almost 3 years mostly on front-end, 
                            ...
                            great and work well on a variety of devices.
                        </p>
                        <p className='text-2xl text-gray-500'>On the back-end, I have been developing robust RESTful APIs using Python and Django, while also managing databases such as MySQL.</p>
                        <p className='text-2xl text-gray-500'>Collaboration plays a key role in my work. I actively contribute to team projects, participating in code reviews, ensuring best practices, and engaging in architecture decisions to design scalable, efficient, and maintainable solutions. By collaborating closely with my team, I help drive technical direction while maintaining high-quality standards in every project.</p>
                    </div>
                </div>
                ...
                <div className='animation-block'>
                    <div className='flex flex-col items-center flex-grow basis-[calc(50%-12px)] border rounded-xl shadow-xl gap-y-4 px-4 py-6 hidden-animation'>
                    ...
                    <div data-right className='flex flex-col items-center flex-grow basis-[calc(50%-12px)] border rounded-xl shadow-xl gap-y-4 px-4 py-6 hidden-animation'>
