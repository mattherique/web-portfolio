        ...
        <section>
            ...
            <div className='flex flex-col gap-y-4'>
                ...
                <p className="text-xl text-gray-600">
                    It seams very tricky, but here you will learn how to make this transition from the beginning <span className="text-xl text-gray-600" id="codebase">without interfere in you actual codebase.</span></p>
            </div>
        </section>
    );
};
