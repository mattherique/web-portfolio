                        ...
                        <div className='mt-10 flex text-black flex-col gap-y-4'>
                            ...
                            <div>
                                <div className='flex items-center gap-x-3 mt-3'>
                                    <Link href='/about'>
                                        <div className='cursor-pointer flex items-center gap-x-3 py-2 px-3 rounded-md bg-[#fff] text-black shadow-lg hover:-mt-2 hover:mb-2  transition-all'> About Me
                                            <MdPersonSearch className='w-9 h-9' />
                                        </div>  
                                    </Link>
                                    <Link href='https://www.linkedin.com/in/matheus-henrique-0a8450135/'>
