...
const MainPage = () => {
    return (    
        <div className='mx-12 xl:mx-auto max-w-6xl h-full'>
            <div className='w-[65%]'>
                ...
                <div className='mt-10 flex flex-col gap-y-4'>
                    ...
                    <div>
                        <div className='flex items-center gap-x-3 mt-3'>
                            ...
                            <Link href='/posts'>
                                <div className='cursor-pointer flex items-center gap-x-3 py-2 px-3 rounded-md bg-[#1c1837] text-white shadow-md hover:-mt-2 border-animation'> Posts
                                    <BsJournalText className='w-9 h-9' />
                                </div>
                            </Link>
                            <Link href='/posts'>
                                <div className='cursor-pointer flex items-center gap-x-3 py-2 px-3 rounded-md bg-[#1c1837] hover:-mt-2 border-animation'> Github
